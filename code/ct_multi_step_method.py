...
phis         = [0.1]        # rotation angle between side info and data
shift       = [0.02, 0.08]  # shift betwwen side info and data
...
for data_fname in data_fnames:
    for phi in phis:
        ...
        gt = np.pad(gt, ((12, 12), (12, 12)), 'constant', 
                        constant_values=0.0014067312735875006)
        sinfo = np.pad(sinfo, ((12, 12), (12, 12)), 'constant',
                        constant_values=0.02259887079937919)
        simage = sinfo.shape
        ...
        for it in range(2):
            ...
            ud_vars = [0]
            file_out = 'recon_{}_init{}_da{}_si{}_vars{}_a{:4.2e}_b{:4.2e}_g{:6.4f}_e{:6.4f}'.format(it, 
                    init_sinfo, data_aligned, use_sinfo, ud_vars, RegParam, beta, gamma, eta)
